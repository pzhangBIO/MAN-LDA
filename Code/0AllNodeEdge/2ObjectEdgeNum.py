...
AllEdge = []
ReadMyCsv(AllEdge, "MDCuiMiDisease.csv")
...
StorFile(AllEdgeNum, 'MDCuiMiDiseaseNum.csv')

# 生成AllLncNum，AllMiNum

AllLncNum = Tool.GenerateAllDrug(AllEdgeNum)
AllMiNum = Tool.GenerateAllDisease(AllEdgeNum)


Tool.StorFile(AllLncNum, 'AllMiNum.csv')
Tool.StorFile(AllMiNum, 'AllDiseaseNum.csv')
